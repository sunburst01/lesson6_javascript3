...
function previewFive() {
   ...
   //clone figure element for fifth image and edit the first image
...
/*******************************************************************************************************/
//create event lsiteners for left arrow, right arrow, and fiveButton elements

function createEventListeners() {
   //declare variable for document element with id of leftarrow, which is in the html document
   var leftarrow = document.getElementById("leftarrow");
   
   //add an event handler to see the specified document element (leftarrow)
   ...
   //add an event handler to the specified document ("rightarrow")
